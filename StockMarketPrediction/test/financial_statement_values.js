...
module.exports = {
    toplam_oazkayank:async function(driver) {
    ...
    Dönem_Net_Kar_Zararı:async function(driver) {
        driver.manage().window().maximize();
    ...
    Toplam_Kısa_Vadeli_Yükümlülükler:async function(driver) {
        driver.manage().window().maximize();
    ...
    Toplam_Uzun_Vadeli_Yükümlülükler:async function(driver) {
        driver.manage().window().maximize();
    ...
    Nakit_ve_Nakit_Benzerleri:async function(driver) {
        driver.manage().window().maximize();
    ...
    ticari_alacaklar:async function(driver) {
        driver.manage().window().maximize();
